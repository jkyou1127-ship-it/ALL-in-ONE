...
// 지정 종목/레벨(관리자가 직접 정함)만 관리한다.

const LICENSE_TYPES = {
  c: { field: "cLicense", label: "C License", subLabel: "Cube", itemsField: "designatedEvents", itemsLabel: "지정 종목" },
  a: { field: "aLicense", label: "A License", subLabel: "ADOFAI", itemsField: "designatedLevels", itemsLabel: "지정 레벨" }
};
...
// 관리자 전용: 발급(신규) 또는 지정 종목/레벨 수정. 기존에 발급된 적이 있으면
// 번호는 그대로 유지하고 지정 항목/활성 여부만 갱신한다.
